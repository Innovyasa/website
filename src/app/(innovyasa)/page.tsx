    ...
    <div>
      ...
      <section style={{ padding: '40px 20px', backgroundColor: '#fff' }}>
        ...
        <div style={{ display: 'flex', gap: '20px' }}>
          <div>
            <h3>Courses</h3>
            <p>Learn from industry experts and gain practical skills in the latest technologies.</p>
          </div>
          <div>
            <h3>Internships</h3>
            <p>Hands-on internship opportunities to apply your skills in real projects.</p>
          </div>
          <div>
            <h3>Devsol</h3>
            <p>Providing IT solutions for college projects and external clients.</p>
          </div>
        </div>
      </section>
      <section style={{ padding: '40px 20px', backgroundColor: '#e9ecef' }}>
      ...
      <footer style={{ padding: '20px', textAlign: 'center', backgroundColor: '#343a40', color: '#fff' }}>
